...
* 
* @package language 
* @version $Id: help_bbcode.php,v 1.0 2008/12/13 10:50:12 Suporte phpBB Exp $ 
...
$help = array( 
   ...
   array( 
      ...
      1 => 'O segundo tipo de listas, a lista ordenada, lhe proporciona controle do que vá aparecer antes de cada item. Para criar uma lista ordenada você utilizará <b>[list=1][/list]</b> de forma a criar uma lista numérica ou, <b>[list=a][/list]</b>, para uma lista alfabética. Da mesma forma que para o tipo de lista sem ordem, os itens são precedidos de <b>[*]</b>. Por exemplo:<br /><br /><b>[list=1]</b><br /><b>[*]</b>Ir às Compras<br /><b>[*]</b>Comprar um Computador Novo<br /><b>[*]</b>Insultar o Computador quando ficar Bloqueado<br /><b>[/list]</b><br /><br />produzirá o seguinte:<ol type=\"1\"><li>Ir às Compras</li><li>Comprar um Computador Novo</li><li>Insultar o Computador quando ficar bloqueado</li></ol> Enquanto que para uma Lista Alfabética você utilizará:<br /><br /><b>[list=a]</b><br /><b>[*]</b>A Primeira Resposta<br /><b>[*]</b>A Segunda Resposta<br /><b>[*]</b>A Terceira Resposta<br /><b>[/list]</b><br /><br />resultando em <ol type=\"a\"><li>A Primeira Resposta</li><li>A Segunda Resposta</li><li>A Terceira Resposta</li></ol>' 
   ), 
   array( 
      0 => '--', 
      1 => 'Criar links' 
